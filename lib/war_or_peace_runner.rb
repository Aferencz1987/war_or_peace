...
@player1_deck = []
@player1_deck << @shuffled_deck.slice[0..25]
@player2_deck = []
@player2_deck << @shuffled_deck.slice[26..51]
player1 = Player.new("Wanda", deck1)
player2 = Player.new("Cowboy", deck2)
...
def start
  p "Welcome to War! (or Peace) This game will be played with 52 cards.
   ...
   if @input == "GO"
    ...
    p "Hey maybe you should try typing GO instead"
  end
end
